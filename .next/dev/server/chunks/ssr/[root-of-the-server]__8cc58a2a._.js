...
;
const metadata = {
    title: "FocusMail - Your Inbox. Silence. Focus.",
    description: "FocusMail scrapes your emails to filter out noise and delivers only critical notifications and summaries.",
    generator: "v0.app",
    icons: {
        icon: [
            {
